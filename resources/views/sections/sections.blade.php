                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-id="{{ $section->id }}"
                                            data-section_name="{{ $section->sections_name }}"
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-id="{{ $section->id }}"
                                            data-section_name="{{ $section->sections_name }}" data-toggle="modal"
...
@section('js')
    ...
    <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var sections_name = button.data('section_name')
    ...
    <script>
        $('#modaldemo9').on('show.bs.modal', function(event) {
            ...
            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #section_name').val(sections_name);
        })
    </script>
@endsection
