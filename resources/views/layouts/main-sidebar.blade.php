...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامح الفاوتير</li>
            <li class="slide">
            ...
            <li class="side-item side-item-category">الفاوتير</li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الفاوتير</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice')) }}"> قائمه الفاوتير </a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'الفاوتير المدفوعه')) }}">'الفاوتير المدفوعه</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'الفاوتير الغير المدفوعه')) }}">'الفاوتير الغير المدفوعه</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'الفاوتير المدفوعه جزئيا')) }}">'الفاوتير المدفوعه جزئيا</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = '')) }}"> تقرير الفاوتير</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}"> تقرير العملاء</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'rangeslider')) }}"> تقرير المنتجات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'calendar')) }}"> تقرير المبيعات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'contacts')) }}"> تقرير المشتريات</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'product')) }}">اضافه المنجات</a></li>
