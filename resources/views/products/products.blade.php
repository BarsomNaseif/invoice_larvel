                            ...
                            <tbody>
                                ...
                                @foreach ($products as $Product)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $Product->section->sections_name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-outline-success btn-sm"
                                                ...
                                                data-section_name="{{ $Product->section->sections_name }}"
                ...
                <div class="modal-content">
                    ...
                    <form action='product/update' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <label class="my-1 mr-2" for="inlineFormCustomSelectPref">القسم</label>
                            <select name="sections_name" id="sections_name" class="custom-select my-1 mr-sm-2" required>
                                @foreach ($sections as $section)
                                    <option>{{ $section->sections_name }}</option>
                                @endforeach
                            </select>
...
@section('js')
    ...
    <script>
        $('#edit_Product').on('show.bs.modal', function(event) {
            ...
            modal.find('.modal-body #sections_name').val(section_name);
